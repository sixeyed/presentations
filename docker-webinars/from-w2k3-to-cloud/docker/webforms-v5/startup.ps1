...
Write-Output 'STARTUP: Starting metrics exporter'
Start-Process -NoNewWindow -WorkingDirectory $env:METRICS_COLLECTOR_ROOT `
              -FilePath "$env:METRICS_COLLECTOR_ROOT\aspnet-exporter.exe"
